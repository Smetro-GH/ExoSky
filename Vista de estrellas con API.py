...
def create_2d_starmap(stars, spectra):
    ...
    ax.set_title(f'View from Exoplanet {np.random.randint(1,5000)}', color='blue')
...
random_star = stars[np.random.randint(len(stars))]
print(f"Coordenadas de estrella al azar: RA={random_star['ra']}, Dec={random_star['dec']},")
